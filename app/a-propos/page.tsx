      ...
      <main className="pb-20 md:pb-0">
          ...
          <div className="max-w-[1280px] mx-auto px-5 md:px-10 py-8 md:py-12">
            <div className="flex flex-col md:grid md:grid-cols-[420px_1fr] gap-8 md:gap-10 items-start">
              ...
              <div className="w-full md:w-auto">
                <div className="relative rounded-[16px] overflow-hidden min-h-[280px] md:min-h-[420px]">
                  ...
                  <div className="absolute bottom-3 right-3 flex gap-1">
                    <span className="font-[var(--font-hanken)] text-[10px] tracking-widest text-[#9a9483] uppercase bg-[rgba(251,249,243,0.7)] px-2 py-1 rounded">
                      PORTRAIT · OUSTAZ
                    </span>
                  </div>
                </div>
              ...
              <div className="flex flex-col justify-center">
                <p className="arabic text-[#b58a3c] text-[18px] text-right mb-3">
                  طلب العلم فريضة
                </p>
                <h1 className="font-[var(--font-cormorant)] font-semibold text-[32px] md:text-[48px] text-[#232a20] leading-tight mb-2">
                  Oustaz Niang Mbaye{" "}
                  <span className="font-[var(--font-hanken)] font-normal text-[24px] md:text-[28px] text-[#6f7363]">(H.A)</span>
                </h1>
                <p className="font-[var(--font-hanken)] text-[14.5px] text-[#6f7363] mb-5">
                  Imam · Prédicateur du Qur&apos;an et de la Sunna
                </p>
                <p className="font-[var(--font-hanken)] text-[14.5px] text-[#3f463a] leading-relaxed mb-8 max-w-[520px]">
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={i} className="text-center md:text-left">
                      <p className="font-[var(--font-cormorant)] font-semibold text-[34px] md:text-[40px] text-[#232a20] leading-none">
                        {stat.value}
                        {stat.sub && (
                          <span className="font-[var(--font-hanken)] text-[18px] text-[#6f7363] ml-1">
                            {stat.sub}
                          </span>
                        )}
                      </p>
                      <p className="font-[var(--font-hanken)] text-[12px] text-[#9a9483] mt-1">
                        {stat.label}
                      </p>
                    </div>
                  ))}
        ...
        <div className="max-w-[1280px] mx-auto px-5 md:px-10 space-y-12 md:space-y-14 py-10 md:py-14">
          ...
          <section className="text-center max-w-[780px] mx-auto">
            <p className="font-[var(--font-hanken)] text-[11px] uppercase tracking-widest text-[#9a9483] font-semibold mb-3">
              Mission
            </p>
            <h2 className="font-[var(--font-cormorant)] font-semibold text-[26px] md:text-[36px] text-[#232a20] leading-tight mb-5">
              Rendre le savoir islamique accessible, authentique et porteur de sérénité
            </h2>
            <p className="arabic text-[#b58a3c] text-[20px]">
          ...
          <section>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              {values.map((v) => (
                <div
                  key={v.numAr}
                  className="bg-[#fbf9f3] border border-[#e2dac9] rounded-[13px] p-6 flex flex-col gap-3"
                >
                  <span className="arabic text-[#3c4a37] text-[28px] leading-none font-bold">{v.numAr}</span>
                  <h3 className="font-[var(--font-cormorant)] font-semibold text-[21px] text-[#232a20]">
                    {v.title}
                  </h3>
                  <p className="font-[var(--font-hanken)] text-[13.5px] text-[#6f7363] leading-relaxed">
                    {v.desc}
                  </p>
                </div>
              ))}
