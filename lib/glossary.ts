export const glossary: Record<string, string> = {
  ...
  rappel: "Une courte intervention ou méditation rappelant un principe fondamental ou un bienfait de la foi.",
...
export const glossaryAr: Record<string, string> = {
  ...
  rappel: "موعظة قصيرة أو تذكير بأصل من أصول الدين أو فضيلة من الفضائل.",
