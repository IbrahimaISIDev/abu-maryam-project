...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 hidden md:block bg-[#fbf9f3] border-b border-[#e2dac9]">
      <nav className="max-w-[1280px] mx-auto flex items-center gap-8 px-10 py-[18px]">
        ...
        <Link href="/" className="flex items-center gap-2.5 shrink-0 mr-4">
          ...
          <div className="flex flex-col">
            <span className="font-[var(--font-cormorant)] font-bold text-[21px] leading-tight text-[#232a20]">
              Abu Maryam{" "}
              <span className="text-[#b58a3c]">TV</span>
            </span>
            <span className="font-[var(--font-hanken)] text-[10px] tracking-[.22em] text-[#9a9483] uppercase">
              Qur&apos;an &amp; Sunna
            </span>
          </div>
        </Link>
              ...
              <li key={href}>
                <Link
                  ...
                  className={`font-[var(--font-hanken)] text-[14.5px] font-medium pb-1 transition-colors ${
                    isActive
                      ? "text-[#3c4a37] border-b-2 border-[#b58a3c]"
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button
            className="font-[var(--font-hanken)] text-[13px] text-[#6f7363] hover:text-[#3c4a37] transition-colors"
          ...
          {/* Bouton recherche */}
          <button
            className="w-[34px] h-[34px] rounded-full border border-[#d8d0bf] flex items-center justify-center text-[#6f7363] hover:border-[#b58a3c] hover:text-[#b58a3c] transition-colors"
