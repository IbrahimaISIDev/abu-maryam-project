...
export default function SeriesProgress({ episodes, variant = "full", lang }: SeriesProgressProps) {
    ...
    <div className="px-5 py-3 border-b border-[#e2dac9] dark:border-[#3a4132] bg-[#f5f1e8] dark:bg-[#242b1e]">
      <div className="flex items-center justify-between mb-1.5">
        <span className="font-[var(--font-hanken)] text-[11.5px] font-medium text-[#6f7363] dark:text-[#b7b2a0]">
          {lang === "ar" ? "تقدمك" : "Votre progression"}
        </span>
        <span dir="ltr" className="font-[var(--font-hanken)] text-[11.5px] font-semibold text-[#3c4a37] dark:text-[#e3c685] tabular-nums">
