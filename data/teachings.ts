...
export const teachings: Teaching[] = [
  ...
  },
  {
    ...
    description:
      "Conférence en français sur l'inimitabilité du Coran (i'jaz) — linguistique, scientifique et spirituelle.",
    level: "débutant",
  },
  {
    id: "4",
  ...
  },
  {
    ...
    description:
      "Khoutba sur l'importance de purifier sa foi de tout ce qui contredit le Tawhîd.",
    level: "débutant",
  },
  {
    id: "12",
...
export function getSeriesEpisodes(seriesId: string): Teaching[] {
  return teachings
    .filter((t) => t.seriesId === seriesId)
    .sort((a, b) => (a.episodeNumber ?? 0) - (b.episodeNumber ?? 0));
}

export function getRelatedTeachings(teaching: Teaching, limit = 4): Teaching[] {
  return teachings
    .filter((t) => t.id !== teaching.id && t.theme === teaching.theme)
    .slice(0, limit);
}
